...
<!--The Register Form -->
<!-- Modal -->
<form class="ms-auto me-auto w-25" style="margin-top: 8%" method="POST" action="${pageContext.request.contextPath}/InsertAdmin">
    <h2 class="text-center fw-bold  mt-5"> Add new Admin </h2>
