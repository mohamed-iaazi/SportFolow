    ...
    <div class="page d-flex">
        <div class="sidebar bg-white p-20 p-relative">
            ...
            <ul>
                ...
                <li>
                    <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="member">
                        <i class="fa-solid fa-gear fa-fw"></i>
                        <span>Member</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="d-flex align-center fs-14 c-black rad-6 p-10" href="trainer">
                        <i class="fa-solid fa-gear fa-fw"></i>
                        <span>Trainer</span>
                    </a>
                </li>
